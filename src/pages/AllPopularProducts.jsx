        ...
        <Container>
             {/* Heading */}
                <div className="heading flex items-center justify-between pb-8">
                    ...
                    <h2 className='font-poppins font-semibold text-xl md:text-heading-05 text-gray-9 pb-2 md:pb-0'>Popular Products</h2>
                    <p className='font-poppins font-medium text-xs max-w-[150px] md:max-w-full md:text-lg text-gray-5'>Handpicked bestsellers loved by our customers</p>
                </div>
                        {/* View Btn */}
                     ...
                     <div className="flex items-center gap-x-1">
                        <button className={`p-2 rounded-md border border-gray-100 cursor-pointer ${view === 'grid' ? 'bg-primary text-white' : 'bg-gray-50 text-gray-9 '}`} onClick={() => setView("grid")}>
                            <BsGrid3X3 />
                        </button>
                        <button className={`p-2 rounded-md border border-gray-100 cursor-pointer ${view === 'list' ? 'bg-primary text-white' : 'bg-gray-50 text-gray-9 '}`} onClick={() => setView("list")}>
                            <CiGrid2V />
                        </button>
                     </div>
                    </div>
            ...
            {/* main content */}
               <div className={` transition-all duration-300 ${view === "grid"
                          ...
                          >
                            ...
                            <div className="p-3 w-full">
                              ...
                              <div className="flex items-center justify-between pb-2 w-full">
                                ...
                                <div className={`flex gap-y-1.5 absolute z-10 ${view === 'list' ? "bottom-3 right-5 flex-row" : "top-2 right-3 flex-col "}`}>
                                  <div
                                  ...
                                  <div  className={`w-7 md:w-10 h-7 md:h-10 rounded-full shadow-md flex items-center justify-center opacity-0 transition-all duration-300 group-hover:opacity-100  bg-white border border-gray-100 cursor-pointer ${view === 'list' ? "translate-y-3  group-hover:translate-y-0" : "translate-x-3 group-hover:translate-x-0 "}`}
            >
