  ...
  return (
   <>
          ...
          {categoriesData.map((item, index) => {
            ...
            return (
              <div
                ...
                className={`${categoriesData.length - 1 > index && index !== 0 && "border-t border-gray-2/50"}`}
              >
                <div
                  ...
                  {isDropdownOpen && (
                    ...
                    >
                      {item?.subCategories?.map((sub, index) => (
                        <p
                          key={index}
                          className="font-poppins font-medium text-sm text-gray-5 hover:underline cursor-pointer"
                        >
                          {sub}
                        </p>
                      ))}
    ...
    {isOpen && 
      ...
      <div className="fixed top-0 inset-0 bg-gray-9/80 z-1"/>}
   </>
  );
};
