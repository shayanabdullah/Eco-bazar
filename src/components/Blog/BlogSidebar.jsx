...
export default function BlogSidebar({
  ...
  useClickOutside(menuRef, () => setIsOpen(false), 'mousedown', isOpen);
  return (
   <>
...
<div className={`md:hidden overlay cursor-pointer bg-black/50 inset-0 fixed top-0 left-0 z-99 ${isOpen ? "block" : "hidden"}`} onClick={() => setIsOpen(false)} />
   </>
  );
}
